# Contributing to Mr.White Shadow
...
3. Increase the version numbers in any examples files and the README.md to the new version that this
   Pull Request would represent. The versioning scheme we use is [ReadMe](https://github.com/whiteshadowofficial/STEFANIE-BOT-MD🎣/blob/master/README.md).

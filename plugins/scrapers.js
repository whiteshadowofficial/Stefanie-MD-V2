...
if (config.WORKTYPE == 'private') {
    ...
    const vcard = 'BEGIN:VCARD\n' // saidali said
            + 'VERSION:3.0\n' 
            + 'FN:Vishnu' //coded by saidali   not copy this
            + 'ORG:Vishnu;\n' // the organization of the contact
            + 'TEL;type=CELL;type=VOICE;waid=+918156804977:918129624395\n' //created saidali
            + 'END:VCARD'
    await message.client.sendMessage(message.jid,{displayname: "Vishnu", vcard: vcard}, MessageType.contact)
}))

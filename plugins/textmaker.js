...
Asena.addCommand({pattern: 'txttoimg$', fromMe: wk, desc: desc_msg}, (async (message, match) => {
    ...
    if (Config.LANG == 'TR' || Config.LANG == 'AZ') {
        ...
        t31 = 'Create a Pornhub Style Logo.'
    }
    else {
    ...
    w5botapi.textpro("https://textpro.me/pornhub-style-logo-online-generator-free-977.html",
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/phub.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/phub.jpg'), MessageType.image, { caption: '_*Fidha BOT*_' })
              })
          } catch(err) { 
              console.log(err)
          } 
